 ...
 * Created on 17 Oct 2017 ( Date ISO 2017-10-17 - Time 10:47:14 )
...
this.STS = 0;                         // data type = Integer   
     ...
     * This field is mapped on the database column "NGAY_CAP" ( type "VARCHAR", NotNull : false ) 
     * @param NGAY_CAP
     */
     ...
     * This field is mapped on the database column "MA_QUAN_LY" ( type "VARCHAR", NotNull : false ) 
     * @param MA_QUAN_LY
     */
     ...
     * This field is mapped on the database column "TEN_CHA_ME" ( type "VARCHAR", NotNull : false ) 
     * @param TEN_CHA_ME
     */
     ...
     * This field is mapped on the database column "MA_DT_SONG" ( type "INT", NotNull : false ) 
     * @param MA_DT_SONG
     */
     ...
     * This field is mapped on the database column "THOIDIEM_NAMNAM" ( type "VARCHAR", NotNull : false ) 
     ...
     * This field is mapped on the database column "CHUOI_KIEM_TRA" ( type "VARCHAR", NotNull : false ) 
 ...
 */
    ...
    public void insert() {
		...
		try {
            ...
            String sql = "insert into benh_nhan (HO_TEN, NGAY_SINH, GIOI_TINH, DIA_CHI, MA_THE, MA_DKBD, GT_THE_TU, GT_THE_DEN, NGAY_CAP, MA_QUAN_LY, TEN_CHA_ME, MA_DT_SONG, THOIDIEM_NAMNAM, CHUOI_KIEM_TRA, DATE_ADD, LAST_EDIT,  STS) values(:HO_TEN, :NGAY_SINH, :GIOI_TINH, :DIA_CHI, :MA_THE, :MA_DKBD, :GT_THE_TU, :GT_THE_DEN, :NGAY_CAP, :MA_QUAN_LY, :TEN_CHA_ME, :MA_DT_SONG, :THOIDIEM_NAMNAM, :CHUOI_KIEM_TRA, :DATE_ADD, :LAST_EDIT,  0)";
    ...
    public void update() {
		...
		try {
            ...
            logger.info("Update [benh_nhan] debug: "+toString());
            connection
					.createQuery(
							"insert into action_log(u_id,u_action,dbtable,actionid,fieldid) values(:u_id,:u_action,:dbtable,:actionid,:fieldid)",
							true)
