...
this.STS = 0;                         // data type = Integer   
     ...
     * This field is mapped on the database column "TYPE" ( type "INT", NotNull : true ) 
     * @param TYPE
     */
 ...
 */
    ...
    public void insert() {
		...
		try {
            ...
            logger.info("Insert [khohang] BEGIN: "+ this.toString());

            String sql = "insert into khohang (TYPE, KHO_NAME,  STS) values(:TYPE, :KHO_NAME,  0)";
            ...
            logger.info("Add [khohang] OK: Data="+this.toString());
		} catch (Exception t) {
    ...
    public void update() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            Khohang temp = Khohang.load(this.KHO_ID);
            if(temp!=null){
            	logger.info("Begin Update [khohang]: "+temp.toString());
            }
            logger.info("Update [khohang] BEGIN: "+ this.toString());
			//
			String sql = "update khohang set TYPE=:TYPE, KHO_NAME=:KHO_NAME, STS=:STS where KHO_ID=:KHO_ID";
			connection
					.createQuery(
							sql,
							true)
            ...
            logger.info("End   Update [khohang]: "+toString());
            connection
					.createQuery(
							"insert into action_log(u_id,u_action,dbtable,actionid,fieldid) values(:u_id,:u_action,:dbtable,:actionid,:fieldid)",
							true)
    ...
    public void delete() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            logger.error("Update Row [khohang] BEGIN: ID=["+KHO_ID +"]. " + this.toString());
	...
	public void deleteRow() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            logger.error("Delete Row [khohang] BEGIN: ID=["+KHO_ID +"]. " + this.toString());
