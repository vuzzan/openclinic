 ...
 */
    ...
    public void insert() {
		...
		try {
            ...
            logger.info("Insert [vendor] BEGIN: "+ this.toString());
    ...
    public void update() {
		...
		try {
            ...
            logger.info("Update [vendor] BEGIN: "+ this.toString());
			//
    ...
    public void delete() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            logger.error("Update Row [vendor] BEGIN: ID=["+V_ID +"]. " + this.toString());
	...
	public void deleteRow() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            logger.error("Delete Row [vendor] BEGIN: ID=["+V_ID +"]. " + this.toString());
