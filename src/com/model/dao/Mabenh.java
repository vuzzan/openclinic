 ...
 */
    ...
    public void insert() {
		...
		try {
            ...
            logger.info("Insert [mabenh] BEGIN: "+ this.toString());
            ...
            logger.info("Add [mabenh] OK: Data="+this.toString());
		} catch (Exception t) {
    ...
    public void update() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            Mabenh temp = Mabenh.load(this.MABENH_ID);
            if(temp!=null){
            	logger.info("Begin Update [mabenh]: "+temp.toString());
            }
            logger.info("Update [mabenh] BEGIN: "+ this.toString());
			//
            ...
            logger.info("End   Update [mabenh]: "+toString());
            connection
					.createQuery(
							"insert into action_log(u_id,u_action,dbtable,actionid,fieldid) values(:u_id,:u_action,:dbtable,:actionid,:fieldid)",
							true)
    ...
    public void delete() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            logger.error("Update Row [mabenh] BEGIN: ID=["+MABENH_ID +"]. " + this.toString());
	...
	public void deleteRow() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            logger.error("Delete Row [mabenh] BEGIN: ID=["+MABENH_ID +"]. " + this.toString());
			String sql = "delete from mabenh where MABENH_ID=:MABENH_ID";
			connection
					.createQuery(
							sql,
							true)
					.addParameter("MABENH_ID", this.MABENH_ID)
					.executeUpdate();
			logger.error("Delete Row [mabenh] OK: ID=["+MABENH_ID +"].");
            connection
					.createQuery(
							"insert into action_log(u_id,u_action,dbtable,actionid,fieldid) values(:u_id,:u_action,:dbtable,:actionid,:fieldid)",
							true)
