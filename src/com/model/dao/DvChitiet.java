 ...
 */
    ...
    public void update() {
		...
		try {
			...
			//
			String sql = "update dv_chitiet set BN_ID=:BN_ID, MA_LK=:MA_LK, DV_ID=:DV_ID, MA_DICH_VU=:MA_DICH_VU, MA_VAT_TU=:MA_VAT_TU, MA_NHOM=:MA_NHOM, TEN_DICH_VU=:TEN_DICH_VU, SO_LUONG=:SO_LUONG, DON_GIA=:DON_GIA, DON_GIA2=:DON_GIA2, THANH_TIEN=:THANH_TIEN, THANH_TIEN2=:THANH_TIEN2, TT_BH=:TT_BH, TT_NB=:TT_NB, MA_KHOA=:MA_KHOA, MA_BAC_SI=:MA_BAC_SI, MA_BENH=:MA_BENH, NGAY_YL=:NGAY_YL, NGAY_KQ=:NGAY_KQ, MA_PTTT=:MA_PTTT, TYLE_TT=:TYLE_TT, STS=:STS where DVCT_ID=:DVCT_ID";
			connection
					.createQuery(
							sql,
							true)
