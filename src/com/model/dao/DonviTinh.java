 ...
 */
    ...
    public void insert() {
		...
		try {
            ...
            logger.info("Insert [donvi_tinh] BEGIN: "+ this.toString());
    ...
    public void update() {
		...
		try {
            ...
            logger.info("Update [donvi_tinh] BEGIN: "+ this.toString());
			//
    ...
    public void delete() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            logger.error("Update Row [donvi_tinh] BEGIN: ID=["+DVT_MA +"]. " + this.toString());
	...
	public void deleteRow() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            logger.error("Delete Row [donvi_tinh] BEGIN: ID=["+DVT_MA +"]. " + this.toString());
