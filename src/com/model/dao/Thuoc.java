...
this.THUOC_RANK = 0;                         // data type = Integer   
     ...
     * This field is mapped on the database column "MA_HOAT_CHAT" ( type "VARCHAR", NotNull : true ) 
     * @param MA_HOAT_CHAT
     */
     ...
     * This field is mapped on the database column "MA_AX" ( type "VARCHAR", NotNull : true ) 
     * @param MA_AX
     */
     ...
     * This field is mapped on the database column "HOAT_CHAT" ( type "VARCHAR", NotNull : true ) 
     * @param HOAT_CHAT
     */
     ...
     * This field is mapped on the database column "HOATCHAT_AX" ( type "VARCHAR", NotNull : true ) 
     * @param HOATCHAT_AX
     */
     ...
     * This field is mapped on the database column "MA_DUONG_DUNG" ( type "VARCHAR", NotNull : true ) 
     * @param MA_DUONG_DUNG
     */
     ...
     * This field is mapped on the database column "MA_DUONGDUNG_AX" ( type "VARCHAR", NotNull : true ) 
     ...
     * This field is mapped on the database column "DUONGDUNG_AX" ( type "VARCHAR", NotNull : true ) 
     * @param DUONGDUNG_AX
     */
     ...
     * This field is mapped on the database column "HAMLUONG_AX" ( type "VARCHAR", NotNull : true ) 
     * @param HAMLUONG_AX
     */
     ...
     * This field is mapped on the database column "TENTHUOC_AX" ( type "VARCHAR", NotNull : true ) 
     * @param TENTHUOC_AX
     */
     ...
     * This field is mapped on the database column "SODANGKY_AX" ( type "VARCHAR", NotNull : true ) 
     * @param SODANGKY_AX
     */
     ...
     * This field is mapped on the database column "DONG_GOI" ( type "VARCHAR", NotNull : true ) 
     * @param DONG_GOI
     */
     ...
     * This field is mapped on the database column "DON_GIA_TT" ( type "INT", NotNull : true ) 
     * @param DON_GIA_TT
     */
     ...
     * This field is mapped on the database column "HANG_SX" ( type "VARCHAR", NotNull : true ) 
     * @param HANG_SX
     */
     ...
     * This field is mapped on the database column "NUOC_SX" ( type "VARCHAR", NotNull : true ) 
     * @param NUOC_SX
     */
     ...
     * This field is mapped on the database column "NHA_THAU" ( type "VARCHAR", NotNull : true ) 
     * @param NHA_THAU
     */
     ...
     * This field is mapped on the database column "MA_THUOC_BV" ( type "VARCHAR", NotNull : true ) 
     * @param MA_THUOC_BV
     */
     ...
     * This field is mapped on the database column "LOAI_THUOC" ( type "INT", NotNull : true ) 
     * @param LOAI_THUOC
     */
     ...
     * This field is mapped on the database column "LOAI_THAU" ( type "INT", NotNull : true ) 
     * @param LOAI_THAU
     */
     ...
     * This field is mapped on the database column "NHOM_THAU" ( type "VARCHAR", NotNull : true ) 
     * @param NHOM_THAU
     */
     ...
     * This field is mapped on the database column "MANHOM_9324" ( type "INT", NotNull : true ) 
     * @param MANHOM_9324
     */
     ...
     * This field is mapped on the database column "HIEULUC" ( type "INT", NotNull : true ) 
     * @param HIEULUC
     */
 ...
 */
    ...
    public void insert() {
		...
		try {
            ...
            String sql = "insert into thuoc (MA_HOAT_CHAT, MA_AX, HOAT_CHAT, HOATCHAT_AX, MA_DUONG_DUNG, MA_DUONGDUNG_AX, DUONG_DUNG, DUONGDUNG_AX, HAM_LUONG, HAMLUONG_AX, TEN_THUOC, TENTHUOC_AX, SO_DANG_KY, SODANGKY_AX, DONG_GOI, DON_VI_TINH, DON_GIA, DON_GIA_TT, SO_LUONG, MA_CSKCB, HANG_SX, NUOC_SX, NHA_THAU, QUYET_DINH, CONG_BO, MA_THUOC_BV, LOAI_THUOC, LOAI_THAU, NHOM_THAU, MANHOM_9324, HIEULUC, KETQUA, THUOC_RANK STS) values(:MA_HOAT_CHAT, :MA_AX, :HOAT_CHAT, :HOATCHAT_AX, :MA_DUONG_DUNG, :MA_DUONGDUNG_AX, :DUONG_DUNG, :DUONGDUNG_AX, :HAM_LUONG, :HAMLUONG_AX, :TEN_THUOC, :TENTHUOC_AX, :SO_DANG_KY, :SODANGKY_AX, :DONG_GOI, :DON_VI_TINH, :DON_GIA, :DON_GIA_TT, :SO_LUONG, :MA_CSKCB, :HANG_SX, :NUOC_SX, :NHA_THAU, :QUYET_DINH, :CONG_BO, :MA_THUOC_BV, :LOAI_THUOC, :LOAI_THAU, :NHOM_THAU, :MANHOM_9324, :HIEULUC, :KETQUA, :THUOC_RANK 0)";
    ...
    public void update() {
		...
		try {
            ...
            logger.info("Update [thuoc] debug: "+toString());
            connection
					.createQuery(
							"insert into action_log(u_id,u_action,dbtable,actionid,fieldid) values(:u_id,:u_action,:dbtable,:actionid,:fieldid)",
							true)
