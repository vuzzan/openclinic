...
this.DON_GIA_TT = 0.0;      // data type = Double    
...
this.THUOC_RANK = 0;                         // data type = Integer   
    ...
    public void copy(Thuoc fromObj)
    {
        if(fromObj==null){
            return;
        }
        this.MA_HOAT_CHAT = fromObj.MA_HOAT_CHAT;
        this.MA_AX = fromObj.MA_AX;
        this.HOAT_CHAT = fromObj.HOAT_CHAT;
        this.HOATCHAT_AX = fromObj.HOATCHAT_AX;
        this.MA_DUONG_DUNG = fromObj.MA_DUONG_DUNG;
        this.MA_DUONGDUNG_AX = fromObj.MA_DUONGDUNG_AX;
        this.DUONG_DUNG = fromObj.DUONG_DUNG;
        this.DUONGDUNG_AX = fromObj.DUONGDUNG_AX;
        this.HAM_LUONG = fromObj.HAM_LUONG;
        this.HAMLUONG_AX = fromObj.HAMLUONG_AX;
        this.TEN_THUOC = fromObj.TEN_THUOC;
        this.TENTHUOC_AX = fromObj.TENTHUOC_AX;
        this.SO_DANG_KY = fromObj.SO_DANG_KY;
        this.SODANGKY_AX = fromObj.SODANGKY_AX;
        this.DONG_GOI = fromObj.DONG_GOI;
        this.DON_VI_TINH = fromObj.DON_VI_TINH;
        this.DON_GIA = fromObj.DON_GIA;
        this.DON_GIA_TT = fromObj.DON_GIA_TT;
        this.SO_LUONG = fromObj.SO_LUONG;
        this.MA_CSKCB = fromObj.MA_CSKCB;
        this.HANG_SX = fromObj.HANG_SX;
        this.NUOC_SX = fromObj.NUOC_SX;
        this.NHA_THAU = fromObj.NHA_THAU;
        this.QUYET_DINH = fromObj.QUYET_DINH;
        this.CONG_BO = fromObj.CONG_BO;
        this.MA_THUOC_BV = fromObj.MA_THUOC_BV;
        this.LOAI_THUOC = fromObj.LOAI_THUOC;
        this.LOAI_THAU = fromObj.LOAI_THAU;
        this.NHOM_THAU = fromObj.NHOM_THAU;
        this.MANHOM_9324 = fromObj.MANHOM_9324;
        this.HIEULUC = fromObj.HIEULUC;
        this.KETQUA = fromObj.KETQUA;
        this.TYP = fromObj.TYP;
        this.THUOC_RANK = fromObj.THUOC_RANK;
    }
    //----------------------------------------------------------------------
     ...
     * This field is mapped on the database column "DON_GIA" ( type "DOUBLE", NotNull : false ) 
     * @param DON_GIA
     */
    ...
    //--- DATABASE MAPPING : DON_GIA_TT ( DOUBLE ) 
    /**
     * Set the "DON_GIA_TT" field value
     * This field is mapped on the database column "DON_GIA_TT" ( type "DOUBLE", NotNull : false ) 
     * @param DON_GIA_TT
     */
    public void setDON_GIA_TT( Double DON_GIA_TT )
    {
