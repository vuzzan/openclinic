 ...
 */
    ...
    public void update() {
		...
		try {
			...
			//
			String sql = "update kham_benh set STT=:STT, BN_ID=:BN_ID, TEN_BENH_NHAN=:TEN_BENH_NHAN, TEN_BENH=:TEN_BENH, MA_BENH=:MA_BENH, MA_BENHKHAC=:MA_BENHKHAC, MA_LYDO_VVIEN=:MA_LYDO_VVIEN, MA_NOI_CHUYEN=:MA_NOI_CHUYEN, MA_TAI_NAN=:MA_TAI_NAN,NGAY_RA=:NGAY_RA, SO_NGAY_DTRI=:SO_NGAY_DTRI, KET_QUA_DTRI=:KET_QUA_DTRI, TINH_TRANG_RV=:TINH_TRANG_RV, NGAY_TTOAN=:NGAY_TTOAN, MUC_HUONG=:MUC_HUONG, T_THUOC=:T_THUOC, T_VTYT=:T_VTYT, T_TONGCHI=:T_TONGCHI, T_BNTT=:T_BNTT, T_BHTT=:T_BHTT, T_NGUONKHAC=:T_NGUONKHAC, T_NGOAIDS=:T_NGOAIDS, NAM_QT=:NAM_QT, THANG_QT=:THANG_QT, MA_LOAI_KCB=:MA_LOAI_KCB, MA_KHOA=:MA_KHOA, MA_CSKCB=:MA_CSKCB, MA_KHUVUC=:MA_KHUVUC, MA_PTTT_QT=:MA_PTTT_QT, CAN_NANG=:CAN_NANG, KB_DATE=:KB_DATE, KIEU_TT=:KIEU_TT, CHANDOAN_BD=:CHANDOAN_BD, STS=:STS where MA_LK=:MA_LK";
			connection
					.createQuery(
							sql,
							true)
