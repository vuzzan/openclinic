 ...
 */
    ...
    public void insert() {
		...
		try {
            ...
            logger.info("Insert [mst_chiso] BEGIN: "+ this.toString());
            ...
            logger.info("Add [mst_chiso] OK: Data="+this.toString());
		} catch (Exception t) {
    ...
    public void update() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            MstChiso temp = MstChiso.load(this.CS_ID);
            if(temp!=null){
            	logger.info("Begin Update [mst_chiso]: "+temp.toString());
            }
            logger.info("Update [mst_chiso] BEGIN: "+ this.toString());
			//
            ...
            logger.info("End   Update [mst_chiso]: "+toString());
            connection
					.createQuery(
							"insert into action_log(u_id,u_action,dbtable,actionid,fieldid) values(:u_id,:u_action,:dbtable,:actionid,:fieldid)",
							true)
    ...
    public void delete() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            logger.error("Update Row [mst_chiso] BEGIN: ID=["+CS_ID +"]. " + this.toString());
	...
	public void deleteRow() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            logger.error("Delete Row [mst_chiso] BEGIN: ID=["+CS_ID +"]. " + this.toString());
