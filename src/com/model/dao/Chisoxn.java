 ...
 */
    ...
    public void insert() {
		...
		try {
            ...
            logger.info("Insert [chisoxn] BEGIN: "+ this.toString());
    ...
    public void update() {
		...
		try {
            ...
            logger.info("Update [chisoxn] BEGIN: "+ this.toString());
			//
    ...
    public void delete() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            logger.error("Update Row [chisoxn] BEGIN: ID=["+CSVN_ID +"]. " + this.toString());
	...
	public void deleteRow() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            logger.error("Delete Row [chisoxn] BEGIN: ID=["+CSVN_ID +"]. " + this.toString());
