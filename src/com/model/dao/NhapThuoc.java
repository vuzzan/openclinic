...
this.TONGCONG = 0.0;      // data type = Double    
this.TONGCONG_VAT = 0.0;      // data type = Double    
this.VAT = 0;                         // data type = Integer   
this.STS = 0;                         // data type = Integer   
        // End Set default value 
    }
    
    public void copy(NhapThuoc fromObj)
    {
        if(fromObj==null){
            return;
        }
        ...
        this.VENDOR_NAME = fromObj.VENDOR_NAME;
        this.VENDOR_ADDR = fromObj.VENDOR_ADDR;
        this.NGAY_NHAP = fromObj.NGAY_NHAP;
        this.NGAY_HD = fromObj.NGAY_HD;
        this.SO_HOA_DON = fromObj.SO_HOA_DON;
        this.KH_HOA_DON = fromObj.KH_HOA_DON;
        this.TONGCONG = fromObj.TONGCONG;
        this.TONGCONG_VAT = fromObj.TONGCONG_VAT;
     ...
     * This field is mapped on the database column "NGAY_HD" ( type "TIMESTAMP", NotNull : false ) 
     * @param NGAY_HD
     */
    ...
    //--- DATABASE MAPPING : TONGCONG ( DOUBLE ) 
    /**
     * Set the "TONGCONG" field value
     * This field is mapped on the database column "TONGCONG" ( type "DOUBLE", NotNull : true ) 
     * @param TONGCONG
     */
    ...
    //--- DATABASE MAPPING : TONGCONG_VAT ( DOUBLE ) 
    /**
     * Set the "TONGCONG_VAT" field value
     * This field is mapped on the database column "TONGCONG_VAT" ( type "DOUBLE", NotNull : true ) 
     * @param TONGCONG_VAT
     */
    public void setTONGCONG_VAT( Double TONGCONG_VAT )
    {
 ...
 */
    ...
    public void insert() {
		...
		try {
            ...
            logger.info("Insert [nhap_thuoc] BEGIN: "+ this.toString());

            String sql = "insert into nhap_thuoc (V_ID, KHO_ID, TENKHO, FROM_KHOID, VENDOR_NAME, VENDOR_ADDR, NGAY_NHAP, NGAY_HD, SO_HOA_DON, KH_HOA_DON, TONGCONG, TONGCONG_VAT, VAT,  STS) values(:V_ID, :KHO_ID, :TENKHO, :FROM_KHOID, :VENDOR_NAME, :VENDOR_ADDR, :NGAY_NHAP, :NGAY_HD, :SO_HOA_DON, :KH_HOA_DON, :TONGCONG, :TONGCONG_VAT, :VAT,  0)";
    ...
    public void update() {
		...
		try {
            ...
            logger.info("Update [nhap_thuoc] BEGIN: "+ this.toString());
			//
			String sql = "update nhap_thuoc set V_ID=:V_ID, KHO_ID=:KHO_ID, TENKHO=:TENKHO, FROM_KHOID=:FROM_KHOID, VENDOR_NAME=:VENDOR_NAME, VENDOR_ADDR=:VENDOR_ADDR, NGAY_NHAP=:NGAY_NHAP, NGAY_HD=:NGAY_HD, SO_HOA_DON=:SO_HOA_DON, KH_HOA_DON=:KH_HOA_DON, TONGCONG=:TONGCONG, TONGCONG_VAT=:TONGCONG_VAT, VAT=:VAT, STS=:STS where NT_ID=:NT_ID";
			connection
					.createQuery(
							sql,
							true)
    ...
    public void delete() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            logger.error("Update Row [nhap_thuoc] BEGIN: ID=["+NT_ID +"]. " + this.toString());
	...
	public void deleteRow() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            logger.error("Delete Row [nhap_thuoc] BEGIN: ID=["+NT_ID +"]. " + this.toString());
