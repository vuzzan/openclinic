 ...
 */
    ...
    public void insert() {
		...
		try {
            ...
            logger.info("Insert [phanquyen] BEGIN: "+ this.toString());
            ...
            logger.info("Add [phanquyen] OK: Data="+this.toString());
		} catch (Exception t) {
    ...
    public void update() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            Phanquyen temp = Phanquyen.load(this.PQ_ID);
            if(temp!=null){
            	logger.info("Begin Update [phanquyen]: "+temp.toString());
            }
            logger.info("Update [phanquyen] BEGIN: "+ this.toString());
			//
            ...
            logger.info("End   Update [phanquyen]: "+toString());
            connection
					.createQuery(
							"insert into action_log(u_id,u_action,dbtable,actionid,fieldid) values(:u_id,:u_action,:dbtable,:actionid,:fieldid)",
							true)
    ...
    public void delete() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            logger.error("Update Row [phanquyen] BEGIN: ID=["+PQ_ID +"]. " + this.toString());
	...
	public void deleteRow() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            logger.error("Delete Row [phanquyen] BEGIN: ID=["+PQ_ID +"]. " + this.toString());
