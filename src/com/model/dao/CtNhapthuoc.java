 ...
 * Created on 10 Nov 2017 ( Date ISO 2017-11-10 - Time 15:57:18 )
 ...
 */
    ...
    public void insert() {
		...
		try {
            ...
            String sql = "insert into ct_nhapthuoc (NT_ID, V_ID, TENKHO, KHO_ID, THUOC_ID, TENTHUOC, DONVI, HANDUNG, LOT_ID, SOLUONG, SL_TONKHO, SL_OUTSTANDING, SL_DADUNG, DONGIA, THANHTIEN, VAT,  STS) values(:NT_ID, :V_ID, :TENKHO, :KHO_ID, :THUOC_ID, :TENTHUOC, :DONVI, :HANDUNG, :LOT_ID, :SOLUONG, :SL_TONKHO, :SL_OUTSTANDING, :SL_DADUNG, :DONGIA, :THANHTIEN, :VAT,  0)";
    ...
    public void update() {
		...
		try {
			...
			//
			String sql = "update ct_nhapthuoc set NT_ID=:NT_ID, V_ID=:V_ID, TENKHO=:TENKHO, KHO_ID=:KHO_ID, THUOC_ID=:THUOC_ID, TENTHUOC=:TENTHUOC, DONVI=:DONVI, HANDUNG=:HANDUNG, LOT_ID=:LOT_ID, SOLUONG=:SOLUONG, SL_TONKHO=:SL_TONKHO, SL_OUTSTANDING=:SL_OUTSTANDING, SL_DADUNG=:SL_DADUNG, DONGIA=:DONGIA, THANHTIEN=:THANHTIEN, VAT=:VAT, STS=:STS where CT_ID=:CT_ID";
			connection
					.createQuery(
							sql,
							true)
