 ...
 */
    ...
    public void insert() {
		...
		try {
            ...
            String sql = "insert into ct_nhapthuoc (NT_ID, V_ID, TENKHO, THUOC_ID, TENTHUOC, DONVI, HANDUNG, SOLUONG, SL_TONKHO, SL_OUTSTANDING, SL_DADUNG, DONGIA, THANHTIEN,  STS) values(:NT_ID, :V_ID, :TENKHO, :THUOC_ID, :TENTHUOC, :DONVI, :HANDUNG, :SOLUONG, :SL_TONKHO, :SL_OUTSTANDING, :SL_DADUNG, :DONGIA, :THANHTIEN,  0)";
    ...
    public void update() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
			String sql = "update ct_nhapthuoc set NT_ID=:NT_ID, V_ID=:V_ID, TENKHO=:TENKHO, THUOC_ID=:THUOC_ID, TENTHUOC=:TENTHUOC, DONVI=:DONVI, HANDUNG=:HANDUNG, SOLUONG=:SOLUONG, SL_TONKHO=:SL_TONKHO, SL_OUTSTANDING=:SL_OUTSTANDING, SL_DADUNG=:SL_DADUNG, DONGIA=:DONGIA, THANHTIEN=:THANHTIEN, STS=:STS where CT_ID=:CT_ID";
			connection
					.createQuery(
							sql,
							true)
            ...
            logger.info("Update [ct_nhapthuoc] debug: "+toString());
            connection
					.createQuery(
							"insert into action_log(u_id,u_action,dbtable,actionid,fieldid) values(:u_id,:u_action,:dbtable,:actionid,:fieldid)",
							true)
