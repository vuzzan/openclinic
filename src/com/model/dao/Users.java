 ...
 * Created on 14 Nov 2017 ( Date ISO 2017-11-14 - Time 14:56:11 )
 ...
 */
    ...
    public void insert() {
		...
		try {
            ...
            logger.info("Insert [users] BEGIN: "+ this.toString());
            ...
            logger.info("Add [users] OK: Data="+this.toString());
		} catch (Exception t) {
    ...
    public void update() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            Users temp = Users.load(this.U_ID);
            if(temp!=null){
            	logger.info("Begin Update [users]: "+temp.toString());
            }
            logger.info("Update [users] BEGIN: "+ this.toString());
			//
            ...
            logger.info("End   Update [users]: "+toString());
            connection
					.createQuery(
							"insert into action_log(u_id,u_action,dbtable,actionid,fieldid) values(:u_id,:u_action,:dbtable,:actionid,:fieldid)",
							true)
    ...
    public void delete() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            logger.error("Update Row [users] BEGIN: ID=["+U_ID +"]. " + this.toString());
	...
	public void deleteRow() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            logger.error("Delete Row [users] BEGIN: ID=["+U_ID +"]. " + this.toString());
