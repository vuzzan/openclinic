 ...
 */
    ...
    public void insert() {
		...
		try {
            ...
            logger.info("Insert [mst_xahuyen] BEGIN: "+ this.toString());
            ...
            logger.info("Add [mst_xahuyen] OK: Data="+this.toString());
		} catch (Exception t) {
    ...
    public void update() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            MstXahuyen temp = MstXahuyen.load(this.DC_ID);
            if(temp!=null){
            	logger.info("Begin Update [mst_xahuyen]: "+temp.toString());
            }
            logger.info("Update [mst_xahuyen] BEGIN: "+ this.toString());
			//
            ...
            logger.info("End   Update [mst_xahuyen]: "+toString());
            connection
					.createQuery(
							"insert into action_log(u_id,u_action,dbtable,actionid,fieldid) values(:u_id,:u_action,:dbtable,:actionid,:fieldid)",
							true)
    ...
    public void delete() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            logger.error("Update Row [mst_xahuyen] BEGIN: ID=["+DC_ID +"]. " + this.toString());
	...
	public void deleteRow() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            logger.error("Delete Row [mst_xahuyen] BEGIN: ID=["+DC_ID +"]. " + this.toString());
