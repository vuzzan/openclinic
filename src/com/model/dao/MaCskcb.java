 ...
 */
    ...
    public void insert() {
		...
		try {
            ...
            logger.info("Insert [ma_cskcb] BEGIN: "+ this.toString());
            ...
            logger.info("Add [ma_cskcb] OK: Data="+this.toString());
		} catch (Exception t) {
    ...
    public void update() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            MaCskcb temp = MaCskcb.load(this.MA_CODE);
            if(temp!=null){
            	logger.info("Begin Update [ma_cskcb]: "+temp.toString());
            }
            logger.info("Update [ma_cskcb] BEGIN: "+ this.toString());
			//
            ...
            logger.info("End   Update [ma_cskcb]: "+toString());
            connection
					.createQuery(
							"insert into action_log(u_id,u_action,dbtable,actionid,fieldid) values(:u_id,:u_action,:dbtable,:actionid,:fieldid)",
							true)
    ...
    public void delete() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            logger.error("Update Row [ma_cskcb] BEGIN: ID=["+MA_CODE +"]. " + this.toString());
	...
	public void deleteRow() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            logger.error("Delete Row [ma_cskcb] BEGIN: ID=["+MA_CODE +"]. " + this.toString());
