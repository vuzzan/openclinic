 ...
 * Created on 15 Dec 2017 ( Date ISO 2017-12-15 - Time 10:44:22 )
...
this.STS = 0;                         // data type = Integer   
    ...
    public void copy(Dichvu fromObj)
    {
        if(fromObj==null){
            return;
        }
        this.MA_DVKT = fromObj.MA_DVKT;
        this.TEN_DVKT = fromObj.TEN_DVKT;
        this.MA_GIA = fromObj.MA_GIA;
        this.DON_GIA = fromObj.DON_GIA;
        this.DON_GIA2 = fromObj.DON_GIA2;
        this.QUYET_DINH = fromObj.QUYET_DINH;
        this.CONG_BO = fromObj.CONG_BO;
        this.NHOM_DV = fromObj.NHOM_DV;
        this.MANHOM_9324 = fromObj.MANHOM_9324;
        this.HIEULUC = fromObj.HIEULUC;
        this.TYP = fromObj.TYP;
        this.DV_RANK = fromObj.DV_RANK;
     ...
     * This field is mapped on the database column "MA_DVKT" ( type "VARCHAR", NotNull : false ) 
     * @param MA_DVKT
     */
     ...
     * This field is mapped on the database column "MA_GIA" ( type "VARCHAR", NotNull : false ) 
     * @param MA_GIA
     */
     ...
     * This field is mapped on the database column "DON_GIA2" ( type "INT", NotNull : true ) 
     * @param DON_GIA2
     */
     ...
     * This field is mapped on the database column "MANHOM_9324" ( type "VARCHAR", NotNull : false ) 
     * @param MANHOM_9324
     */
     ...
     * This field is mapped on the database column "HIEULUC" ( type "VARCHAR", NotNull : false ) 
     * @param HIEULUC
     */
 ...
 */
    ...
    public void insert() {
		...
		try {
            ...
            logger.info("Insert [dichvu] BEGIN: "+ this.toString());

            String sql = "insert into dichvu (MA_DVKT, TEN_DVKT, MA_GIA, DON_GIA, DON_GIA2, QUYET_DINH, CONG_BO, NHOM_DV, MANHOM_9324, HIEULUC, TYP, DV_RANK,  STS) values(:MA_DVKT, :TEN_DVKT, :MA_GIA, :DON_GIA, :DON_GIA2, :QUYET_DINH, :CONG_BO, :NHOM_DV, :MANHOM_9324, :HIEULUC, :TYP, :DV_RANK,  0)";
            ...
            logger.info("Add [dichvu] OK: Data="+this.toString());
		} catch (Exception t) {
    ...
    public void update() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            Dichvu temp = Dichvu.load(this.DV_ID);
            if(temp!=null){
            	logger.info("Begin Update [dichvu]: "+temp.toString());
            }
            logger.info("Update [dichvu] BEGIN: "+ this.toString());
			//
			String sql = "update dichvu set MA_DVKT=:MA_DVKT, TEN_DVKT=:TEN_DVKT, MA_GIA=:MA_GIA, DON_GIA=:DON_GIA, DON_GIA2=:DON_GIA2, QUYET_DINH=:QUYET_DINH, CONG_BO=:CONG_BO, NHOM_DV=:NHOM_DV, MANHOM_9324=:MANHOM_9324, HIEULUC=:HIEULUC, TYP=:TYP, DV_RANK=:DV_RANK, STS=:STS where DV_ID=:DV_ID";
			connection
					.createQuery(
							sql,
							true)
            ...
            logger.info("End   Update [dichvu]: "+toString());
            connection
					.createQuery(
							"insert into action_log(u_id,u_action,dbtable,actionid,fieldid) values(:u_id,:u_action,:dbtable,:actionid,:fieldid)",
							true)
    ...
    public void delete() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            logger.error("Update Row [dichvu] BEGIN: ID=["+DV_ID +"]. " + this.toString());
	...
	public void deleteRow() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            logger.error("Delete Row [dichvu] BEGIN: ID=["+DV_ID +"]. " + this.toString());
