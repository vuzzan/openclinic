 ...
 * Created on 28 Dec 2017 ( Date ISO 2017-12-28 - Time 18:48:41 )
...
public class ThuocChitiet implements Serializable
{
    ...
    public Double     T_NGUON_KHAC ;
    public Double     T_BNCCT ;
    public Double     T_NGOAIDS ;
    public Integer    NT_ID ;
    public Double     TT_BHTT ;
    public Double     TT_BNTT ;
...
this.DON_GIA = 0.0;      // data type = Double    
this.THANH_TIEN = 0.0;      // data type = Double    
...
this.T_NGUON_KHAC = 0.0;      // data type = Double    
this.T_BNCCT = 0.0;      // data type = Double    
this.T_NGOAIDS = 0.0;      // data type = Double    
this.NT_ID = 0;                         // data type = Integer   
this.TT_BHTT = 0.0;      // data type = Double    
this.TT_BNTT = 0.0;      // data type = Double    
...
this.STS = 0;                         // data type = Integer   
    ...
    //--- DATABASE MAPPING : DON_GIA ( DOUBLE ) 
    /**
     * Set the "DON_GIA" field value
     * This field is mapped on the database column "DON_GIA" ( type "DOUBLE", NotNull : true ) 
     * @param DON_GIA
     */
    ...
    //--- DATABASE MAPPING : THANH_TIEN ( DOUBLE ) 
    /**
     * Set the "THANH_TIEN" field value
     * This field is mapped on the database column "THANH_TIEN" ( type "DOUBLE", NotNull : true ) 
     * @param THANH_TIEN
     */
    ...
    //--- DATABASE MAPPING : T_NGUON_KHAC ( DOUBLE ) 
    /**
     * Set the "T_NGUON_KHAC" field value
     * This field is mapped on the database column "T_NGUON_KHAC" ( type "DOUBLE", NotNull : true ) 
     * @param T_NGUON_KHAC
     */
    public void setT_NGUON_KHAC( Double T_NGUON_KHAC )
    {
    ...
    //--- DATABASE MAPPING : TT_BHTT ( DOUBLE ) 
    /**
     * Set the "TT_BHTT" field value
     * This field is mapped on the database column "TT_BHTT" ( type "DOUBLE", NotNull : true ) 
     * @param TT_BHTT
     */
    public void setTT_BHTT( Double TT_BHTT )
    {
     ...
     * @return the field value
     */
    public Double getTT_BHTT()
    {
        return this.TT_BHTT;
    }

    //--- DATABASE MAPPING : TT_BNTT ( DOUBLE ) 
    /**
     * Set the "TT_BNTT" field value
     * This field is mapped on the database column "TT_BNTT" ( type "DOUBLE", NotNull : true ) 
     * @param TT_BNTT
     */
    public void setTT_BNTT( Double TT_BNTT )
    {
 ...
 */
    ...
    public void insert() {
		...
		try {
            ...
            String sql = "insert into thuoc_chitiet (STT, MA_LK, THUOC_ID, MA_THUOC, MA_NHOM, TEN_THUOC, DON_VI_TINH, HAM_LUONG, DUONG_DUNG, LIEU_DUNG, SO_DANG_KY, TT_THAU, PHAM_VI, SO_LUONG, DON_GIA, THANH_TIEN, MA_KHOA, MA_BAC_SI, MA_BENH, MA_PTTT, TYLE_TT, CT_ID, MUC_HUONG, T_NGUON_KHAC, T_BNCCT, T_NGOAIDS, NT_ID, TT_BHTT, TT_BNTT, KHO_ID, KHO_NAME, CUR_DATE, TYP, THANHTOAN, NV_ID, NV_NAME,  STS) values(:STT, :MA_LK, :THUOC_ID, :MA_THUOC, :MA_NHOM, :TEN_THUOC, :DON_VI_TINH, :HAM_LUONG, :DUONG_DUNG, :LIEU_DUNG, :SO_DANG_KY, :TT_THAU, :PHAM_VI, :SO_LUONG, :DON_GIA, :THANH_TIEN, :MA_KHOA, :MA_BAC_SI, :MA_BENH, :MA_PTTT, :TYLE_TT, :CT_ID, :MUC_HUONG, :T_NGUON_KHAC, :T_BNCCT, :T_NGOAIDS, :NT_ID, :TT_BHTT, :TT_BNTT, :KHO_ID, :KHO_NAME, :CUR_DATE, :TYP, :THANHTOAN, :NV_ID, :NV_NAME,  0)";
