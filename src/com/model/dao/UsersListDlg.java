...
public class UsersListDlg extends Dialog {
	static Logger logger = LogManager.getLogger(UsersListDlg.class.getName());
	 ...
	 * @param style
	 */
	public UsersListDlg(Shell parent, int style) {
		super(parent, style);
		setText("SWT Dialog");
	}
	...
	private void createContents() {
		...
		mntmNewItemUsers.setImage(SWTResourceManager.getImage(UsersDlg.class, "/png/arrow-circle-top-2x.png"));
		mntmNewItemUsers.setText("New");
		
		MenuItem mntmEditItemUsers = new MenuItem(menuUsers, SWT.NONE);
		mntmEditItemUsers.setImage(SWTResourceManager.getImage(UsersDlg.class, "/png/wrench-2x.png"));
		...
		mntmDeleteUsers.setImage(SWTResourceManager.getImage(UsersDlg.class, "/png/circle-x-2x.png"));
