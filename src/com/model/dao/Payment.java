 ...
 */
    ...
    public void insert() {
		...
		try {
            ...
            logger.info("Insert [payment] BEGIN: "+ this.toString());
    ...
    public void update() {
		...
		try {
            ...
            logger.info("Update [payment] BEGIN: "+ this.toString());
			//
    ...
    public void delete() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            logger.error("Update Row [payment] BEGIN: ID=["+PAID_ID +"]. " + this.toString());
	...
	public void deleteRow() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            logger.error("Delete Row [payment] BEGIN: ID=["+PAID_ID +"]. " + this.toString());
