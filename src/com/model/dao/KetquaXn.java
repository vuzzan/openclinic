 ...
 */
    ...
    public void insert() {
		...
		try {
            ...
            logger.info("Insert [ketqua_xn] BEGIN: "+ this.toString());
            ...
            logger.info("Add [ketqua_xn] OK: Data="+this.toString());
		} catch (Exception t) {
    ...
    public void update() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            KetquaXn temp = KetquaXn.load(this.KQXN_ID);
            if(temp!=null){
            	logger.info("Begin Update [ketqua_xn]: "+temp.toString());
            }
            logger.info("Update [ketqua_xn] BEGIN: "+ this.toString());
			//
            ...
            logger.info("End   Update [ketqua_xn]: "+toString());
            connection
					.createQuery(
							"insert into action_log(u_id,u_action,dbtable,actionid,fieldid) values(:u_id,:u_action,:dbtable,:actionid,:fieldid)",
							true)
    ...
    public void delete() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            logger.error("Update Row [ketqua_xn] BEGIN: ID=["+KQXN_ID +"]. " + this.toString());
	...
	public void deleteRow() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            logger.error("Delete Row [ketqua_xn] BEGIN: ID=["+KQXN_ID +"]. " + this.toString());
