 ...
 */
    ...
    public void insert() {
		...
		try {
            ...
            logger.info("Insert [duongdung] BEGIN: "+ this.toString());
            ...
            logger.info("Add [duongdung] OK: Data="+this.toString());
		} catch (Exception t) {
    ...
    public void update() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            Duongdung temp = Duongdung.load(this.DD_ID);
            if(temp!=null){
            	logger.info("Begin Update [duongdung]: "+temp.toString());
            }
            logger.info("Update [duongdung] BEGIN: "+ this.toString());
			//
            ...
            logger.info("End   Update [duongdung]: "+toString());
            connection
					.createQuery(
							"insert into action_log(u_id,u_action,dbtable,actionid,fieldid) values(:u_id,:u_action,:dbtable,:actionid,:fieldid)",
							true)
    ...
    public void delete() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            logger.error("Update Row [duongdung] BEGIN: ID=["+DD_ID +"]. " + this.toString());
	...
	public void deleteRow() {
		...
		try {
			connection = DbHelper.getSql2o();
            connection.setRollbackOnException(false);
            logger.error("Delete Row [duongdung] BEGIN: ID=["+DD_ID +"]. " + this.toString());
